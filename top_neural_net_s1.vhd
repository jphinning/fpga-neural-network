...
architecture Behavioral of Top_NeuralNet_S1 is
    ...
    signal theta_delay  : data_array_t(0 to LUT_LATENCY-1); -- NEW: Delay theta too
    
    signal buffers_write_en : std_logic;
    signal envelope_aligned : data_t;
    signal theta_aligned    : data_t; -- NEW
...
begin
    ...
    theta_unwrapped_out <= theta_aligned; -- NEW: Output aligned theta
